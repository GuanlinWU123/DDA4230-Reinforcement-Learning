...
# Test Q-learning
print("-------------epsilon=0.1, temperature=0-------------")
...
print("Q: ", Q, "\npolicy: ", policy)
print("-------------epsilon=0.3, temperature=0-------------")
...
print("Q: ", Q, "\npolicy: ", policy)
print("-------------epsilon=0.5, temperature=0-------------")
...
print("Q: ", Q, "\npolicy: ", policy)
print("-------------epsilon=0, temperature=10-------------")
...
print("Q: ", Q, "\npolicy: ", policy)
print("-------------epsilon=0, temperature=20-------------")
...
for epsilon in epsilons:
    results[epsilon] = rlProblem.compute_average_cumulative_reward(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),
...
plt.title('Average Cumulative Discounted Rewards per Episode')
plt.legend()
plt.grid(True)
plt.show()
...
for temperature in temperatures:
    results[temperature] = rlProblem.compute_average_cumulative_reward(s0=0,initialQ=np.zeros([mdp.nActions,mdp.nStates]),
                                                                   nEpisodes=200,nSteps=100,epsilon=0, temperature=temperature)

# Plotting
plt.figure(figsize=(10, 6))
for temperature, rewards in results.items():
    plt.plot(rewards, label=f'Temperature={temperature}')

plt.xlabel('Episodes')
plt.ylabel('Average Cumulative Discounted Rewards')
plt.title('Average Cumulative Discounted Rewards per Episode with Boltzmann Exploration')
plt.legend()
plt.grid(True)
plt.show()